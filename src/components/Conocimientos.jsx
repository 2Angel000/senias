...
export default function Conocimientos() {
  return (
    <>
      <ul className=" text-justify m-auto lg:pl-12 pb-12 sep">
        <li className="text-gray-700 text-base">
          <span className="text-teal-600 font-bold">{"{ }"}</span>
          <span className="lg:espaciado text-teal-600"> Lenguajes de Programación
          </span>
        ...
        <li className="text-gray-700 text-base">
          ...
          <span className="lg:espaciado text-teal-600"> Frameworks/Librerías</span>
          <p>Laravel, React, Bootstrap, Flutter, TailwindCSS</p>
        </li>

        <li className="text-gray-700 text-base">
          <i className="fa-solid fa-terminal text-teal-600" />
          <span className="lg:espaciado text-teal-600"> Entornos de desarrollo
          </span>
        ...
        <li className="text-gray-700 text-base">
          ...
          <span className="lg:espaciado text-teal-600"> Bases de datos</span>
          <p>MySQL, Oracle, Firebase</p>
        </li>

        <li className="text-gray-700 text-base pb-3">
          <i className="fa-brands fa-git text-teal-600" />
          <span className="lg:espaciado text-teal-600"> Otras</span>
          <p>
